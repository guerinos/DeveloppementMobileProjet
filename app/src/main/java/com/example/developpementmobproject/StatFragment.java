...
public class StatFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button buttonAddMatch = v.findViewById(R.id.button6);
        buttonAddMatch.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                Intent addMatchActivityIntent = new Intent(getActivity(), AddMatchActivity.class);
                startActivity(addMatchActivityIntent);
            }
